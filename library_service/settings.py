...
SECRET_KEY = "django-insecure-" + os.getenv(
    "SECRET_KEY", default="68v5p^27cc*x1779^0)uwwzaw-1eyk)__*um7d)*og-bayr+=y"
)
...
# Set this option if you are using an https connection
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Cool API for library",
    "VERSION": "2.0.0",
...
DOMAIN_NAME = "http://localhost:8090"
